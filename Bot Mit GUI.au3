...
$CfgSelectionBox = GUICtrlCreateCombo("CfgSelectionBox", 344, 368, 137, 25, BitOR($CBS_DROPDOWN, $CBS_AUTOHSCROLL))
GUISetState(@SW_SHOW)
...
$currentCfgPath = $cfgPath & GUICtrlRead($CfgSelectionBox)
